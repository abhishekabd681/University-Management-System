...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            super("About Us - Dr.BR Ambedkar University");
            ...
            JLabel l6 = new JLabel("Developed By : Abhishek chauhan");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l8 = new JLabel("Contact : abhishekabd681@gmail.com");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("Education - B.Tech (Mechanical)");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 320, 600, 34);
            contentPane.add(l9);


            JLabel l10 = new JLabel("Phone - +917300572899");
